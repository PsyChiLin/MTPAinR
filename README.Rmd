...
The present repository contains the `R` code to (1) use **MTPA** (2) and make comparision with MUA. Also, code to generate some example figures are provided.
